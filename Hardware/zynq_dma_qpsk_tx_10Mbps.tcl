...
proc create_root_design { parentCell } {
  ...
  # Create instance: axis_data_fifo_rftx, and set properties
  set axis_data_fifo_rftx [ create_bd_cell -type ip -vlnv xilinx.com:ip:axis_data_fifo:2.0 axis_data_fifo_rftx ]
  set_property -dict [ list \
   CONFIG.HAS_AEMPTY {1} \
   CONFIG.HAS_AFULL {1} \
  ...
  # Create instance: pulse_shaping_filter, and set properties
...
connect_bd_intf_net -intf_net [get_bd_intf_nets QPSK_data_converter_0_out] [get_bd_intf_pins Repeater_0/in] [get_bd_intf_pins ila_1/SLOT_0_AXIS]
  ...
  connect_bd_net -net axcache_coherent_dout [get_bd_pins axcache_coherent/dout] [get_bd_pins zynq_ultra_ps_e_0/saxigp0_arcache] [get_bd_pins zynq_ultra_ps_e_0/saxigp0_awcache]
